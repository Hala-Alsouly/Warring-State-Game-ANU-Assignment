...
public class zyRowColumnHasCard {
    ...
    public void testIsGoal() {
        ...
        for (int i = 0; i < EDGE_CASE_PLACEMENTS.length; i++) {
            ...
            assertTrue("no card in the array EDGE_CASE_PLACEMENTS line " + (i + 1)+ " in the same row or column of Zhang Yi",
                    WarringStatesGame.zyRowColumnHasCard(test));
        }
    }

    @Test
    public void testIsNotGoal() {
        assertTrue("has card in the array EDGE_CASE_PLACEMENTS line 8 in the same row or column of Zhang Yi",
                 !WarringStatesGame.zyRowColumnHasCard(EDGE_CASE_PLACEMENTS[7]));
    }
}
